    ...
    function GenerateCalender(events) {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function (info) {
                ...
                "<p><b>Start:</b> " + formatDate(selectedEvent.start) +
                    "</p>" +
                (calEvent.end ? "<p><b>End:</b> " + formatDate(selectedEvent.end) + "</p>" : "") +
                    "<p><b>Description:</b> " +
            ...
            eventDrop: function (info) {
                ...
                var data = {
                    Id: calEvent.id,
                    Name: calEvent.title,
                    Start: moment(calEvent.start).format(),
                    End: moment(calEvent.end).format(),
                    Description: calEvent.extendedProps.description,
                    ThemeColor: calEvent.backgroundColor,
                    SubjectId: calEvent.extendedProps.subject.id,
                    Status: calEvent.extendedProps.status,
                };
                SaveEvent(data);
            }
        });
